...
// Returns a file id
int bmp085_i2c_Begin(const char *fileName)
{
	int fd;
...
void bmp085_Calibration(const char *i2cFileName)
{
	int fd = bmp085_i2c_Begin(i2cFileName);
...
unsigned int bmp085_ReadUT(const char *i2cFileName)
{
	unsigned int ut = 0;
	int fd = bmp085_i2c_Begin(i2cFileName);
...
unsigned int bmp085_ReadUP(const char *i2cFileName)
{
	unsigned int up = 0;
	int fd = bmp085_i2c_Begin(i2cFileName);
