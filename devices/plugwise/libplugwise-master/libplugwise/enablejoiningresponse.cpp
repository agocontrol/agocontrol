...
std::string EnableJoiningResponse::str() {
  std::ostringstream oss;
  oss << "Enable Joining Response: " << std::endl;
...
void EnableJoiningResponse::parse_line2() {
...
bool EnableJoiningResponse::req_successful() {
