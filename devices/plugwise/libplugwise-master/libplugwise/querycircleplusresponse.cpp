...
std::string QueryCirclePlusResponse::str() {
  std::ostringstream oss;
  oss << "Query Circle Plus Response: " << std::endl;
...
void QueryCirclePlusResponse::parse_line2() {
...
bool QueryCirclePlusResponse::req_successful() {
