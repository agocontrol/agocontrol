...
#ifndef LIBPLUGWISE_PINGREQUEST_HPP
#define LIBPLUGWISE_PINGREQUEST_HPP 1
...
namespace plugwise {
  class PingRequest : public Request {
    public:
      typedef std::tr1::shared_ptr<PingRequest> Ptr;
      PingRequest (std::string circle_mac) :
    ...
    private:
      PingRequest (const PingRequest& original);
      PingRequest& operator= (const PingRequest& rhs);
