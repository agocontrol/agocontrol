...
std::string SetBroadcastIntervalResponse::str() {
  std::ostringstream oss;
  oss << "Set Broadcast Interval Response: " << std::endl;
...
void SetBroadcastIntervalResponse::parse_line2() {
...
bool SetBroadcastIntervalResponse::req_successful() {
